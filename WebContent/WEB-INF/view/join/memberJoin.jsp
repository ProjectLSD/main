	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="/band/input" method="post" style="font-size: 12pt;"
					class="form-inline">
					...
					<div class="form-group" style="padding-bottom: 5px;">
						<label>Password :</label> <input type="password"
							required="required" class="form-control" name="pass"
							placeholder=" 패스워드">
					</div>
					<br />
					<div class="form-group" style="padding-bottom: 5px;">
						<label>Confirm :&nbsp;&nbsp;&nbsp;</label> <input type="password"
							class="form-control" name="passcon" placeholder=" 패스워드확인">
					</div>
					<br />
					<div class="form-group" style="padding-bottom: 5px;">
